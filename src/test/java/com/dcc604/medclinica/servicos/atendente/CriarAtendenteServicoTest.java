...
class CriarAtendenteServicoTest {
    ...
    static {
        atendenteDTO = CriarAtendenteDTO.builder().cpf("12345678900").carteiraDeTrabalho(123456).build();
    ...
    void naoCriaAtendente_Atendente_JaExistente_CT() {
        when(repositorio.findByCarteiraDeTrabalho(atendenteDTO.getCarteiraDeTrabalho()))
